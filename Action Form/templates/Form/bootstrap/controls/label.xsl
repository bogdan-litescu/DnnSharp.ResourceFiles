    ...
    <xsl:template name="ctl-label">
        ...
        <xsl:if test="/Form/Settings/LabelAlign != 'inside'">
            <label class="">
                ...
                <xsl:attribute name="style"><xsl:if test="/Form/Settings/LabelAlign != 'default'">text-align: <xsl:value-of select="/Form/Settings/LabelAlign" />; </xsl:if><xsl:if test="/Form/Settings/LabelWidth > 0">width: <xsl:value-of select="/Form/Settings/LabelWidth"/>px;</xsl:if> <xsl:value-of select="LabelCssStyles"/></xsl:attribute>
