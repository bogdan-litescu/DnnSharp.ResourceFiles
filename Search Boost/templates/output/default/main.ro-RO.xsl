...
<xsl:template match="/search">
    ...
    <div class = "avtsbDefault" >
        <div class = "avtsb_title_big">
            Se afișează rezultatele de la <b><xsl:value-of select="summary/first_result" /></b> la <b><xsl:value-of select="summary/last_result" /></b>
        </div>
        <br /><br />
        ...
        Căutarea dvs. după <b><xsl:value-of select="summary/term" disable-output-escaping="yes" /></b> a generat <b><xsl:value-of select="summary/resultcount" /></b> rezultate în <xsl:value-of select="summary/execution_time" /> de secunde.
        </div>
    </div>
</xsl:template>
