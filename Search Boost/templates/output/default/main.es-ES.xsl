...
<xsl:template match="/search">
    ...
    <div class = "avtsbDefault" >
        <div class = "avtsb_title_big">
             Resultados <b><xsl:value-of select="summary/first_result" /> - <xsl:value-of select="summary/last_result" /></b>
        </div>
        <br /><br />
        ...
        <xsl:for-each select = "results/result">
            <div class = "avtsb_result">
				...
				<div style="float: left; margin: 4px; 0 0 6px;">
					<a>
        ...
        La búsqueda para <b><xsl:value-of select="summary/term" disable-output-escaping="yes" /></b> generó <b><xsl:value-of select="summary/resultcount" /></b> resultados en <xsl:value-of select="summary/execution_time" /> segundos.
        </div>
    </div>
</xsl:template>
