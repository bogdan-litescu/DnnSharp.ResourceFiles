...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_BarOutsetBlack">
                    ...
                    <div class = "sbInputStart">
                        <div class = "sbInputEnd">
                            <div class = "sbInputInner">
                                <input type="text" class="searchBox" onfocus="sbInp_BarOutsetBlack_removePlaceholder(this);" onblur="sbInp_BarOutsetBlack_checkInput(this)">
    ...
    <script type="text/javascript">
        function sbInp_BarOutsetBlack_removePlaceholder (sbox) {
            sbox = avt.sb.$(sbox);
            if (sbox.hasClass("searchBoxEmpty")) {
                sbox.removeClass("searchBoxEmpty").val("");
            }
        }
        function sbInp_BarOutsetBlack_checkInput(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        avt.sb.$(document).ready(function() {
            avt.sb.$(".sbInp_BarOutsetBlack .searchBox").each(function() {
                sbInp_BarOutsetBlack_checkInput(this);
            });
        });
    </script>
