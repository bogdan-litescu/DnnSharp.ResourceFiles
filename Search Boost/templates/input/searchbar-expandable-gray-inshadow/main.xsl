...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_BarExapdanbleGrayInShadow">
    ...
    <script type="text/javascript">
		var vbox = avt.sb.$(".sbInp_BarExapdanbleGrayInShadow .searchBox").width();
        ...
        avt.sb.$(document).ready(function() {
            ...
            avt.sb.$(".sbInp_BarExapdanbleGrayInShadow .searchBox").each(function() {
