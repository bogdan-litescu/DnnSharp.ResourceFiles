...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_BarFlatRed">
        ...
        <div class = "sbInputStart">
            <div class = "sbInputEnd">
                <div class = "sbInputInner">
                    <input type="text" class="searchBox" onfocus="sbInp_BarFlatRed_removePlaceholder(this);" onblur="sbInp_BarFlatRed_checkInput(this)">
    ...
    <script type="text/javascript">
        function sbInp_BarFlatRed_removePlaceholder (sbox) {
            sbox = avt.sb.$(sbox);
            if (sbox.hasClass("searchBoxEmpty")) {
                sbox.removeClass("searchBoxEmpty").val("");
            }
        }
        function sbInp_BarFlatRed_checkInput(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        avt.sb.$(document).ready(function() {
            avt.sb.$(".sbInp_BarFlatRed .searchBox").each(function() {
                sbInp_BarFlatRed_checkInput(this);
            });
        });
    </script>
