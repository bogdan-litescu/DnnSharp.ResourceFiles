...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_BarFlatOrange">
        ...
        <div class = "sbInputStart">
            <div class = "sbInputEnd">
                <div class = "sbInputInner">
                    <input type="text" class="searchBox" onfocus="sbInp_BarFlatOrange_removePlaceholder(this);" onblur="sbInp_BarFlatOrange_checkInput(this)">
            ...
            <div class="sbBarEnd">
                <div class="sbBarInner">
                    ...
                    <xsl:if test="isModule != 'true' and isAdmin='true'">
                        <div style="float: left; margin: 0px 0 0 6px; line-height: 26px;">
    ...
    <script type="text/javascript">
        function sbInp_BarFlatOrange_removePlaceholder (sbox) {
            sbox = avt.sb.$(sbox);
            if (sbox.hasClass("searchBoxEmpty")) {
                sbox.removeClass("searchBoxEmpty").val("");
            }
        }
        function sbInp_BarFlatOrange_checkInput(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        avt.sb.$(document).ready(function() {
            avt.sb.$(".sbInp_BarFlatOrange .searchBox").each(function() {
                sbInp_BarFlatOrange_checkInput(this);
            });
        });
    </script>
