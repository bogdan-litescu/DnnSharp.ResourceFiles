...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_BarFlatBlue">
        ...
        <div class = "sbInputStart">
            <div class = "sbInputEnd">
                <div class = "sbInputInner">
                    <input type="text" class="searchBox" onfocus="sbInp_BarFlatBlue_removePlaceholder(this);" onblur="sbInp_BarFlatBlue_checkInput(this)">
