...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/input">
        ...
        <div class="sbInp sbInp_BarExapdanbleGrayOutShadow">
            <div class = "sbInputInner">
                ...
                <div class="topSearch">
                    ...
                    <xsl:if test="isModule != 'true' and isAdmin='true'">
                        <div style="margin: 15px 0 0 6px; float: right;">
        ...
        <script type="text/javascript">
            var vbox = avt.sb.$(".sbInp_BarExapdanbleGrayOutShadow .searchBox").width();
            ...
            avt.sb.$(".sbInp_BarExapdanbleGrayOutShadow .searchBox").each(function() {
