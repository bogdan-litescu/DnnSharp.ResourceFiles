...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_IconHoverRed">
		
        <div class="sbIconHover" onmouseover="sbInp_IconHoverRed_showPopup(avt.sb.$(this).next());"></div>
    
        <div class="sbSimpleBox" style="display: none;" onmouseout="sbInp_IconHoverRed_hidePopup(this);" onmouseover="sbInp_IconHoverRed_showPopup(this);">
            ...
            <div class="sbSimpleBoxContent">
                ...
                <input type="text" class="searchBox" onfocus="sbInp_IconHoverRed_removePlaceholder(this);" onblur="sbInp_IconHoverRed_checkInput(this)">
    ...
    <script type="text/javascript">
        function sbInp_IconHoverRed_removePlaceholder (sbox) {
            sbox = avt.sb.$(sbox);
            if (sbox.hasClass("searchBoxEmpty")) {
                sbox.removeClass("searchBoxEmpty").val("");
            }
        }
        function sbInp_IconHoverRed_checkInput(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        function sbInp_IconHoverRed_hidePopup(sbox) {
            sbox = avt.sb.$(sbox);
            timerPopup<xsl:value-of select="instanceId" /> = setTimeout(function() {
                sbox.fadeOut(200);
            }, 400);
        }
        function sbInp_IconHoverRed_showPopup(sbox) {
            sbox = avt.sb.$(sbox);
            clearTimeout(timerPopup<xsl:value-of select="instanceId" />);
            sbox.fadeIn(200);
        }
        avt.sb.$(document).ready(function() {
            avt.sb.$(".sbInp_IconHoverRed .searchBox").each(function() {
                sbInp_IconHoverRed_checkInput(this);
            });
        });
    </script>
