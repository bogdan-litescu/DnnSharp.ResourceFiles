...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_IconHoverBarDarkGray">
		
        <div class="sbIconHover" onmouseover="sbInp_IconHoverBarDarkGray_showPopup(avt.sb.$(this).next());"></div>
        <div class="sbBarStart" style="display: none;" onmouseout="sbInp_IconHoverBarDarkGray_hidePopup(this);" onmouseover="sbInp_IconHoverBarDarkGray_showPopup(this);">
            <div class="sbBarEnd">
                    ...
                    <div class = "sbInputStart">
                        <div class = "sbInputEnd">
                            <div class = "sbInputInner">
                                <input type="text" class="searchBox" onfocus="sbInp_IconHoverBarDarkGray_removePlaceholder(this);" onblur="sbInp_IconHoverBarDarkGray_checkInput(this)">
    ...
    <script type="text/javascript">
        function sbInp_IconHoverBarDarkGray_removePlaceholder (sbox) {
            sbox = avt.sb.$(sbox);
            if (sbox.hasClass("searchBoxEmpty")) {
                sbox.removeClass("searchBoxEmpty").val("");
            }
        }
        function sbInp_IconHoverBarDarkGray_checkInput(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        function sbInp_IconHoverBarDarkGray_hidePopup(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        function sbInp_IconHoverBarDarkGray_showPopup(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        avt.sb.$(document).ready(function() {
            avt.sb.$(".sbInp_IconHoverBarDarkGray .searchBox").each(function() {
                sbInp_IconHoverBarDarkGray_checkInput(this);
            });
        });
    </script>
