...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_BarFlatBlueRed">
        ...
        <div class = "sbInputStart">
            <div class = "sbInputEnd">
                <div class = "sbInputInner">
                    <input type="text" class="searchBox" onfocus="sbInp_BarFlatBlueRed_removePlaceholder(this);" onblur="sbInp_BarFlatBlueRed_checkInput(this)">
        ...
        <xsl:if test="isModule != 'true' and isAdmin='true'">
            <div style="float: left; margin: 4px 0 0 6px; line-height: 26px;">
    ...
    <script type="text/javascript">
        function sbInp_BarFlatBlueRed_removePlaceholder (sbox) {
            sbox = avt.sb.$(sbox);
            if (sbox.hasClass("searchBoxEmpty")) {
                sbox.removeClass("searchBoxEmpty").val("");
            }
        }
        function sbInp_BarFlatBlueRed_checkInput(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        avt.sb.$(document).ready(function() {
            avt.sb.$(".sbInp_BarFlatBlueRed .searchBox").each(function() {
                sbInp_BarFlatBlueRed_checkInput(this);
            });
        });
    </script>
