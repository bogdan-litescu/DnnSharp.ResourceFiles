...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_BarInsetBlue">
                    ...
                    <div class = "sbInputStart">
                        <div class = "sbInputEnd">
                            <div class = "sbInputInner">
                                <input type="text" class="searchBox" onfocus="sbInp_BarInsetBlue_removePlaceholder(this);" onblur="sbInp_BarInsetBlue_checkInput(this)">
    ...
    <script type="text/javascript">
        function sbInp_BarInsetBlue_removePlaceholder (sbox) {
            sbox = avt.sb.$(sbox);
            if (sbox.hasClass("searchBoxEmpty")) {
                sbox.removeClass("searchBoxEmpty").val("");
            }
        }
        function sbInp_BarInsetBlue_checkInput(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        avt.sb.$(document).ready(function() {
            avt.sb.$(".sbInp_BarInsetBlue .searchBox").each(function() {
                sbInp_BarInsetBlue_checkInput(this);
            });
        });
    </script>
