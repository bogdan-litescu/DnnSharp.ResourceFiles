...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_BarOutsetRed">
                    ...
                    <div class = "sbInputStart">
                        <div class = "sbInputEnd">
                            <div class = "sbInputInner">
                                <input type="text" class="searchBox" onfocus="sbInp_BarOutsetRed_removePlaceholder(this);" onblur="sbInp_BarOutsetRed_checkInput(this)">
    ...
    <script type="text/javascript">
        function sbInp_BarOutsetRed_removePlaceholder (sbox) {
            sbox = avt.sb.$(sbox);
            if (sbox.hasClass("searchBoxEmpty")) {
                sbox.removeClass("searchBoxEmpty").val("");
            }
        }
        function sbInp_BarOutsetRed_checkInput(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        avt.sb.$(document).ready(function() {
            avt.sb.$(".sbInp_BarOutsetRed .searchBox").each(function() {
                sbInp_BarOutsetRed_checkInput(this);
            });
        });
    </script>
