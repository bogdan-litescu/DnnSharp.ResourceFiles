...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_BoxSimpleBlue">
        ...
        <div class="sbSimpleBox">
            ...
            <div class="sbSimpleBoxContent">
                ...
                <input type="text" class="searchBox" onfocus="sbInp_BoxSimpleBlue_removePlaceholder(this);" onblur="sbInp_BoxSimpleBlue_checkInput(this)">
    ...
    <script type="text/javascript">
        function sbInp_BoxSimpleBlue_removePlaceholder (sbox) {
            sbox = avt.sb.$(sbox);
            if (sbox.hasClass("searchBoxEmpty")) {
                sbox.removeClass("searchBoxEmpty").val("");
            }
        }
        function sbInp_BoxSimpleBlue_checkInput(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        avt.sb.$(document).ready(function() {
            avt.sb.$(".sbInp_BoxSimpleBlue .searchBox").each(function() {
                sbInp_BoxSimpleBlue_checkInput(this);
            });
        });
    </script>
