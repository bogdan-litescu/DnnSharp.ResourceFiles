...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_IconHoverOrange">
		
        <div class="sbIconHover" onmouseover="sbInp_IconHoverOrange_showPopup(avt.sb.$(this).next());"></div>
        
        <div class="sbSimpleBox" style="display: none;" onmouseout="sbInp_IconHoverOrange_hidePopup(this);" onmouseover="sbInp_IconHoverOrange_showPopup(this);">
            ...
            <div class="sbSimpleBoxContent">
                ...
                <input type="text" class="searchBox" onfocus="sbInp_IconHoverOrange_removePlaceholder(this);" onblur="sbInp_IconHoverOrange_checkInput(this)">
    ...
    <script type="text/javascript">
        function sbInp_IconHoverOrange_removePlaceholder (sbox) {
            sbox = avt.sb.$(sbox);
            if (sbox.hasClass("searchBoxEmpty")) {
                sbox.removeClass("searchBoxEmpty").val("");
            }
        }
        function sbInp_IconHoverOrange_checkInput(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        function sbInp_IconHoverOrange_hidePopup(sbox) {
            sbox = avt.sb.$(sbox);
            timerPopup<xsl:value-of select="instanceId" /> = setTimeout(function() {
                sbox.fadeOut(200);
            }, 400);
        }
        function sbInp_IconHoverOrange_showPopup(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        avt.sb.$(document).ready(function() {
            avt.sb.$(".sbInp_IconHoverOrange .searchBox").each(function() {
                sbInp_IconHoverOrange_checkInput(this);
            });
        });
    </script>
