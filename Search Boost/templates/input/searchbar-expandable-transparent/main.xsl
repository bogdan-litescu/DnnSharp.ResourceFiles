...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_BarExapdanbleTransparent">
    ...
    <script type="text/javascript">
		var vbox = avt.sb.$(".sbInp_BarExapdanbleTransparent .searchBox").width();
        ...
        avt.sb.$(document).ready(function() {
            ...
            avt.sb.$(".sbInp_BarExapdanbleTransparent .searchBox").each(function() {
