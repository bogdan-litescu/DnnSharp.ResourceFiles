...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_BarInsetDarkGray">
                    ...
                    <div class = "sbInputStart">
                        <div class = "sbInputEnd">
                            <div class = "sbInputInner">
                                <input type="text" class="searchBox" onfocus="sbInp_BarInsetDarkGray_removePlaceholder(this);" onblur="sbInp_BarInsetDarkGray_checkInput(this)">
    ...
    <script type="text/javascript">
        function sbInp_BarInsetDarkGray_removePlaceholder (sbox) {
            sbox = avt.sb.$(sbox);
            if (sbox.hasClass("searchBoxEmpty")) {
                sbox.removeClass("searchBoxEmpty").val("");
            }
        }
        function sbInp_BarInsetDarkGray_checkInput(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        avt.sb.$(document).ready(function() {
            avt.sb.$(".sbInp_BarInsetDarkGray .searchBox").each(function() {
                sbInp_BarInsetDarkGray_checkInput(this);
            });
        });
    </script>
