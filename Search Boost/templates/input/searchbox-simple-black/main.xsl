...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_BoxSimpleBlack">
        ...
        <div class="sbSimpleBox">
            ...
            <div class="sbSimpleBoxContent">
                ...
                <input type="text" class="searchBox" onfocus="sbInp_BoxSimpleBlack_removePlaceholder(this);" onblur="sbInp_BoxSimpleBlack_checkInput(this)">
    ...
    <script type="text/javascript">
        function sbInp_BoxSimpleBlack_removePlaceholder (sbox) {
            sbox = avt.sb.$(sbox);
            if (sbox.hasClass("searchBoxEmpty")) {
                sbox.removeClass("searchBoxEmpty").val("");
            }
        }
        function sbInp_BoxSimpleBlack_checkInput(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        avt.sb.$(document).ready(function() {
            avt.sb.$(".sbInp_BoxSimpleBlack .searchBox").each(function() {
                sbInp_BoxSimpleBlack_checkInput(this);
            });
        });
    </script>
