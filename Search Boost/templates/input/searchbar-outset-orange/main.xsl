...
<xsl:template match="/input">
    ...
    <div class="sbInp sbInp_BarOutsetOrange">
                    ...
                    <div class = "sbInputStart">
                        <div class = "sbInputEnd">
                            <div class = "sbInputInner">
                                <input type="text" class="searchBox" onfocus="sbInp_BarOutsetOrange_removePlaceholder(this);" onblur="sbInp_BarOutsetOrange_checkInput(this)">
    ...
    <script type="text/javascript">
        function sbInp_BarOutsetOrange_removePlaceholder (sbox) {
            sbox = avt.sb.$(sbox);
            if (sbox.hasClass("searchBoxEmpty")) {
                sbox.removeClass("searchBoxEmpty").val("");
            }
        }
        function sbInp_BarOutsetOrange_checkInput(sbox) {
            sbox = avt.sb.$(sbox);
        ...
        avt.sb.$(document).ready(function() {
            avt.sb.$(".sbInp_BarOutsetOrange .searchBox").each(function() {
                sbInp_BarOutsetOrange_checkInput(this);
            });
        });
    </script>
